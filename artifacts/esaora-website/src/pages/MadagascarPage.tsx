...
const FOCUS_AREAS = [
  { name: 'Toroy Izy', color: '#001BB7', href: '/programs/toroy-izy', desc: 'Youth orientation and mentoring helping young people in Toliara discover purpose, choose academic and career pathways, and grow through guidance.' },
      ...
      <section className="bg-[#F0F4F8] py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              <span className="text-[#001BB7] uppercase tracking-widest text-xs font-bold block mb-4">Where We Work</span>
            ...
            <div className="bg-brand-navy rounded-lg p-8">
              <p className="text-[#001BB7] text-xs uppercase tracking-widest font-bold mb-4">Organization Snapshot</p>
      ...
      <section className="bg-white py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <span className="text-[#001BB7] uppercase tracking-widest text-xs font-bold block mb-3">Programmes in Toliara</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {FOCUS_AREAS.map((area) => (
              <Link key={area.name} href={area.href} className="group bg-[#F0F4F8] rounded-lg p-7 border border-black/5 hover:-translate-y-1 transition-all">
                <h3 className="text-brand-navy font-bold text-lg mb-3 group-hover:text-[#001BB7] transition-colors">{area.name}</h3>
