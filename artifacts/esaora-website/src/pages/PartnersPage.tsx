  ...
  return (
    <main>
      ...
      <section className="bg-[#f8fafc] py-24 px-4 border-b border-black/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-[#204f79] uppercase tracking-widest text-xs font-bold block mb-3">Our Core Partners</span>
              ...
              {partners.map((p) => (
                <div key={p.id} className="bg-white rounded-xl border border-black/5 overflow-hidden flex flex-col group hover:shadow-2xl hover:shadow-brand-navy/5 transition-all duration-500 hover:-translate-y-1">
                  ...
                  <div className="p-8 flex-1 flex flex-col items-center text-center bg-[#F1F5F9]/30">
                    {p.country && (
                      <span className="bg-[#E8EAF8] text-[#204f79] text-[9px] font-bold uppercase tracking-widest px-3 py-1 rounded-lg mb-4">
                        {p.country}
                      </span>
                    )}
                    ...
                    {p.website_url && (
                      <div className="w-full pt-6 border-t border-black/5">
                        <a href={p.website_url} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 text-brand-navy font-bold text-xs uppercase tracking-widest group-hover:text-[#204f79] transition-colors mx-auto">
      ...
      <section className="bg-white py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <span className="text-[#204f79] uppercase tracking-widest text-xs font-bold block mb-3">Partner With Us</span>
            ...
            {[
              ...
              <div key={block.step} className="bg-[#F0F4F8] rounded-lg p-8 border border-black/5 shadow-sm">
                <div className="flex items-center gap-3 mb-5">
                  <div className="w-10 h-10 bg-brand-navy rounded-lg flex items-center justify-center text-[#204f79] text-sm font-bold">{block.step}</div>
                ...
                <ul className="space-y-2.5">
                  {block.items.map((item) => (
                    <li key={item} className="flex items-start gap-2 text-[#4A5568] text-xs leading-relaxed">
                      <Check className="w-3.5 h-3.5 text-[#204f79] flex-shrink-0 mt-0.5" />
                      {item}
                    </li>
                  ))}
                </ul>
          ...
          <div className="text-center">
            <Link href="/contact" className="inline-block bg-[#204f79] hover:bg-[#F78A28] text-white px-10 py-4 rounded-lg font-bold text-base transition-all hover:scale-105 shadow-lg shadow-[#204f79]/30">
              Contact Us About Partnership
            </Link>
            <p className="text-[#718096] text-xs mt-4">Questions? Contact <a href="mailto:info@mahilalamadagascar.org" className="text-[#204f79] hover:underline">info@mahilalamadagascar.org</a></p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-brand-navy py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <span className="text-[#204f79] uppercase tracking-widest text-xs font-bold bg-[#204f79]/10 px-4 py-1.5 rounded-lg inline-block mb-4">Collaboration Areas</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {COLLABORATION_TYPES.map((benefit, i) => (
              <div key={i} className="flex items-start gap-4 bg-white/5 border border-white/10 rounded-lg p-5">
                <div className="w-7 h-7 bg-[#204f79]/15 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                  <Check className="w-3.5 h-3.5 text-[#204f79]" />
                </div>
          ...
          <div className="text-center mt-12">
            <Link href="/contact" className="inline-block bg-[#204f79] hover:bg-[#F78A28] text-white px-8 py-3.5 rounded-lg font-bold text-sm transition-all hover:scale-105">
      ...
      <section className="bg-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <span className="text-[#204f79] uppercase tracking-widest text-xs font-bold block mb-4">Known Collaborators</span>
